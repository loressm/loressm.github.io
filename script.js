document.addEventListener("DOMContentLoaded", function () {
    ...
    const elements = document.querySelectorAll('.animate-text');  // Aggiunto per l'animazione del testo
    ...
    // Animazione del testo (aggiunta per l'effetto al caricamento)
    ...
    // Chiamato ogni volta che la pagina scrolla
    window.addEventListener('scroll', checkVisibility);

    // Prima verifica all'avvio
    checkVisibility();

    // Intersection Observer per attivare le animazioni (contatore e barre)
